...
<div class="flex flex-col gap-6">
    ...
    <form wire:submit="login" class="flex flex-col gap-6">
        ...
        <flux:input wire:model="email" label="Dirección de correo electrónico" type="email" name="email" required autofocus autocomplete="email" placeholder="correo@ejemplo.com" />
